...
% Last Modified by GUIDE v2.5 06-Aug-2017 21:57:42
...
global pre img;
default_path='.\image';
[filename,pathname]=uigetfile({'*.jpg';'*bmp';'*.png'},'选择图片',default_path);
%合成图片路径+文件名
...
global pre0 img0
default_path='.\image';
[filename,pathname]=uigetfile({'*.jpg';'*bmp';'*.gif'},'选择图片',default_path);
%合成图片路径+文件名
...
str1= fprintf(save_txt,'eye similarity is %.4f\n', rst_eye);
...
'Position',[9.8 12.7142857142857 17.8 2.35714285714286],...
...
'String','图片1的路径',...
'Style','text',...
'Position',[27.4 12.8571428571429 68 2.21428571428571],...
'Children',[],...
'ParentMode','manual',...
'Tag','text1',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String','选择图片2',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[109.8 12.5 18.6 2.14285714285714],...
...
'String','图片2的路径',...
'Style','text',...
'Position',[128.2 12.5 65.8 2.14285714285714],...
'Children',[],...
'ParentMode','manual',...
'Tag','text2',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
